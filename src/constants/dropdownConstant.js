...
export const productFilter = [
    ...
    },
    {
        id: 'delivery-form',
        name: 'Delivery Form',
        subName: 'Delivery Form'
    },
    {
        id: 'package-type',
        name: 'Package Type',
        subName: 'Package Type'
    },
    {
        id: 'price',
        name: 'Price',
...
export const orderFilters = [
    ...
    },
    {
        ...
        subName: 'Last Changed By'
    },
    {
        id:'tracking',
        name: 'Tracking#',
        subName: 'Tracking Number'
    },
    {
        id:'credit-card',
        name: 'Credit Card',
        subName: 'Last 4 Digit'
    },
   
]

export const customerOrderFilters = [
...
export const userRoleDropdown = [
    { title: 'Partner Admin', value: 0 },
    { title: 'Center Admin', value: 1 },
    { title: 'Pharmacist', value: 2 },
    { title: 'CSR', value: 3 },
    { title: 'Agent', value: 4 },
    { title: 'EPCS', value: 5 },
    { title: 'Locked', value: 6 },
]

export const orderTypeDropdown = [
    { title: 'None', value: 0},
    { title: 'Shopify', value:1 },
    { title: 'Manual', value: 2 },
]
export const orderStatusDropdown = [
    { title: 'Pending Orders', value: 0},
    { title: 'Completed Orders', value:1 },
    { title: 'Fulfilled Order', value: 2 },
    { title: 'Problem Order', value: 3 },
]
...
export const years = Array.from(new Array(20),( val, index) => {return  {title: `${index + year}`, value: index + year}});
